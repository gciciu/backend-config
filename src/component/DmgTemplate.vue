                ...
                <mdb-card-body>
                  ...
                  <mdb-row>
                    ...
                    <mdb-col xl="3" class="pb-1" v-if="isExternalResource">
                      <mdb-select multiple selectAll search @getValue="getExternalResource" :options="allExternalResourceOption" class="mt-0 mb-3 width90"  id="relatedMultiplyFields" size="sm" ariaDescribedBy="relatedMultiplyFields" />
                    </mdb-col>
                    <mdb-col xl="1"  md="2"  lg="1" sm="12" class="pb-2">
