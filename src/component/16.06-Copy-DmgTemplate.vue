        ...
        <mdb-col xl="6" class="pb-2">
          ...
          >
            <div
                ...
                @click="setCurrentSelectedGroup(groupname.name)" v-for="groupname in groupnames" v-bind:class="{ liIsActive: currentSelectedGroup == groupname.name }"
                :key="groupname.name"
            >
            ...
            <mdb-tbl-head>
              ...
              >
                <div
                    ...
                    v-for="(property, propertyIndex) in propertyGroup[currentSelectedGroup]" @click="setCurrentSelectedProperty(property.name, property.id, property.uniqueId)"
                    :key="property.name"
                >
                  <div class="dmg-table-template">
                    <div class="dmg-table-template-row">
    ...
    <mdb-modal class="modalOptionValues" size="lg" centered v-if="characteristicsValuesModal" @close="characteristicsValuesModal = false">
      ...
      <mdb-col class="mb-6">
            ...
            <mdb-card>
              ...
              <mdb-card-body>
                <mdb-row class="d-flex justify-content-center">
                  ...
                  <mdb-col xl="2" class="pb-2">
                    <mdb-input placeholder="Platzhalter" v-model="fieldValue"  class="mt-0 mb-2" ariaLabel="ID" ariaDescribedBy="valueWertLabel">
                  ...
                  <mdb-col xl="2" class="pb-2">
                    <mdb-input placeholder="Preis" v-model="fieldPriceValue"  class="mt-0 mb-2" ariaLabel="ID" ariaDescribedBy="fieldPriceWertLabel">
                      <mdb-btn color="geccomButtonInfo" size="sm" group id="fieldPriceWertLabel" slot="prepend"  @click.native="openDocuIdModal = true" class="infoCircleBtn"><mdb-icon icon="info-circle" /></mdb-btn>
                    </mdb-input>
                  </mdb-col>
                  <mdb-col>
        ...
        <mdb-row class="mb-3">
          <mdb-col xl="12">
            <mdb-card>
              ...
              <mdb-card-body>
                <mdb-row>
                  <mdb-col xl="2" md="6" sm="12" class="pb-2">
                    <form-inline>
                  ...
                  <mdb-col xl="3" class="pb-3">
                    <div class="input-group">
                      <div class="input-group-prepend" v-if="data_type != 'matrix' && (data_type == 'radioBox' || data_type == 'checkBox' || data_type == 'imageList' || data_type == 'selectBox' || data_type == 'font')">
                      ...
                      <select v-if="data_type != 'matrix' && (data_type == 'radioBox' || data_type == 'checkBox' || data_type == 'imageList' || data_type == 'selectBox' || data_type == 'font')" class="browser-default custom-select" v-model="standardValue">
                        <option v-for="option in standardValues" v-bind:value="option.value" :selected="option.selected">{{ option.text }}</option>
                      </select>
                      <div v-if="data_type != 'matrix' && data_type == 'textField' && data_type == 'upload'">
                  ...
                  <mdb-col xl="1" class="pb-1" v-if="data_type == 'imageBox'">
                  ...
                  <mdb-col xl="1" class="pb-1" v-if="data_type == 'imagecollection'">
                  ...
                  <mdb-col xl="1" class="pb-1" v-if="data_type != 'imageBox'">
                    <mdb-input placeholder="Einheit" v-model="unitValue"  class="mt-0 mb-1" ariaLabel="ID" ariaDescribedBy="unitValueLabel">
                      <mdb-btn color="geccomButtonInfo" size="sm" group id="unitValueLabel" slot="prepend"  @click.native="openDocuIdModal = true" class="infoCircleBtn"><mdb-icon icon="info-circle" /></mdb-btn>
                    </mdb-input>
                  </mdb-col>
                </mdb-row>
                <mdb-row>
        ...
        <mdb-row class="mb-3" v-if="data_type === 'selectBox' ||  data_type === 'imageList' || data_type === 'checkBox'|| data_type === 'radioBox' || data_type === 'font'">
          <mdb-col xl="12">
            <mdb-card>
              <mdb-card-header color="success-color">Werteliste</mdb-card-header>
              <mdb-card-body>
                <mdb-row class="d-flex justify-content-center">
                  <mdb-col xl="12">
                    <div v-if="data_type === 'selectBox' ||  data_type === 'imageList' || data_type === 'checkBox'|| data_type === 'radioBox' || data_type === 'font'">
                      ...
                      <div id="container-combined-image">
                        ...
                        <table class="table">
                          ...
                          <draggable v-model="selectBoxData">
                            <tr v-for="(selectbox,index) in selectBoxData">
                              ...
                              <td>{{selectbox.procenttype == 2 ? "Prozentig" : "Fix Preis"}}</td>
                      ...
                      <mdb-row class="ruleRow gcm-hoverableRow"  v-for="(inputCond, conditionIndex) in ruleItem.condition">
                        ...
                        <mdb-col md="2">
                          <select class="browser-default custom-select" v-model="newRule[newRuleIndex].condition[conditionIndex].conditionBy" :id="`condition_model_${ruleItem.id}_${inputCond.id}`">
                            ...
                            <option value="5">Konponente is inaktive</option>
                            <option value="6">Konponente is aktive</option>
                        ...
                        <mdb-col md="7">
                          <mdb-form-inline class="gcm-ruleCheckbox">
                            <div v-for="(propertyItemValue, propertyItemValueIndex) in newRule[newRuleIndex].condition[conditionIndex].conditionValue">
                              ...
                              <div v-else-if="newRule[newRuleIndex].condition[conditionIndex].dataType == 'textField'  && newRule[newRuleIndex].condition[conditionIndex].conditionBy == 4">
              ...
              <mdb-card-body>
                <mdb-row class="d-flex justify-content-center">
                  <mdb-col xl="12">
                    ...
                    <img v-show="configuration_image_name != ''" v-bind:src="getImagePath(configuration_image_name)" :withd="configuration_image_width"  :height="configuration_image_height">
  ...
  export default {
    ...
    data () {
      return {
        ...
        conditionItem: {
          id: null, propertyId: null, propertyName: null, relationalCondition: null,conditionBy: null , conditionValue:[]
        },
        ruleItem: {id: null, condition: null, allowedValues: []},
        allRules :[] ,
        ...
        configuration_procenttype: null,
        configuration_value: '',
    ...
    methods: {
      ...
      addRowCondition(index) {
        this.newRule[index].condition.push({
          id: this.newRule[index].condition.length, parentUniqueId: null, uniqueId: null, propertyName: null, relationalCondition:null, conditionBy: null , conditionValue:[]
        });
      ...
      saveOptionConfiguration() {
        this.configurationData =
          {
            "price": this.configuration_price, 'title': this.configuration_title, 'value':this.configuration_value, "uniqueId" : this.configuration_uniqueid,
            ...
            "position_x": this.configuration_position_x, "position_y": this.configuration_position_y, "sku": this.configuration_sku, "procenttype": this.configuration_procenttype,
          };
      ...
      fetchProperty(selectedTemplateId) {
        ...
        axios.get(this.restApiDomain+"/api/tplproperies/"+selectedTemplateId)
          .then((response)  =>  {
            ...
            let encodedGroups = self.decode(response.data['groups']);
            let encodedpropertyValue = self.decode(response.data['propertyValue']);
            let encodedUniqueIds = self.decode(response.data['uniqueIds']);
...
/*
      ...
      addNewOptionForm: function() {
        ...
        this.selectBoxData[indexSelectBox] = {uniqueId: Date.now(),title: this.selectBoxTitle, value: this.selectBoxValue, price :this.selectBoxPrice, procenttype: this.procenttype};
      ...
      openEditConfigurationOptionModal(index) {
        ...
        this.configuration_procenttype = this.selectBoxData[index].procenttype;
      ...
      setCurrentSelectedProperty(currentSelectedProperty, currentSelectedPropertyIndex, currentUniqueId) {
      ...
      savePropertyValue(selectedProperty) {
        ...
        let propertyValueItem = {uniqueId: this.uniqueId, fieldId: this.fieldId, titel: this.fieldTitel, expression: this.expression, imageUploadName: this.templateImage, position: this.fieldPosition, valueCssClass: this.valueCssClass, maxValue: this.maxValue, minValue: this.minValue, multiplyFields:  multiplyFieldsLocal,
          ...
          operatorCombi: this.operatorCombi, dataTyp : this.data_type, mandatory_field: this.requiredField, fieldActive: this.activeField, fieldValue: this.fieldValue, price: this.fieldPriceValue, matrix: this.matrixCollection, additionalData: this.selectBoxData, isDigit: this.isDigit, dmgIsbasicPrice: this.dmgIsbasicPrice};
