    ...
    <div class="container-fluid">
        ...
        <div id="wrapper">
            ...
            <div id="template-block">
                <DmGTemplate v-if="selectedTemplateId != null" v-model="selectedTemplateId" :selected-template-id="selectedTemplateId" :selected-template-name="selectedTemplate"></DmGTemplate>
            </div>
      ...
      */
      ...
      chooseComponent(selectedComponent){
        if(selectedComponent != undefined) {
          ...
          this.selectedTemplate = selectedComponent.name;
        }
      ...
      saveTemplateName() {
        ...
        axios.post(this.restApiDomain+'/api/tpls', {
          ...
          .then(function (response) {
            self.selectedTemplateName = response.data.name;
